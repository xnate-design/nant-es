    ...
    <div className='mb-4 text-secondary' translate='no'>
      <div className='flex w-full rounded-t-lg bg-gray-200 dark:bg-gray-80'>
        ...
        <div className='flex text-sm px-4'>
          <div className='flex items-center border-b-2 border-gray-300 dark:border-gray-90 text-tertiary dark:text-tertiary-dark'>
            Console
          </div>
      ...
      <div
        className={cn(
          'flex px-4 pt-4 pb-6 items-center content-center text-code rounded-b-md',
          {
      ...
      >
        {/* {level === 'error' && <BugOutline className="self-start text-2xl" />} */}
        {/* {level === 'warning' && <WarningOutline className="self-start" />} */}
